    ...
    return (
        <Drawer
                ...
                footer={
                    <HStack>
                        <Box>
                            <Button isLoading={submitting} size='sm' rounded='sm' type="submit" form="form">Submit</Button>
                        </Box>
                    </HStack>
                }
                >
                <form id="form" onSubmit={handleSubmit}>
                    <Image objectFit='cover' boxSize='150px' rounded="0" src={ state?.thumbnail?.preview || process.env.PUBLIC_URL+'/images/image.png'} onClick={(e) => selectFile() }  />
